...
> Estado al 2026-05-19 — sitio en vivo en [ia.itera.es](https://ia.itera.es/). El procedimiento de iteración diaria (rutina CEO) actualiza esta tabla cuando cambia el alcance.

> ✅ **Deploy gap 2026-05-18 → 2026-05-19 resuelto.** Los commits `f99a92c` y `e3ef770` se empujaron a `origin/main` en la iteración del 2026-05-19 invocando `git push` con un credential helper inline que usa el secret `aiteamGithubAll` como contraseña y `x-access-token` como usuario (en vez del PAT por defecto del worktree). Patrón documentado en [ITEAA-1755](/ITEAA/issues/ITEAA-1755).
...
| Tutorial / contenidos por nivel de adopción | desplegada (4 niveles + empleo) | `site/aprende/01..04` + `contratar-en-la-era-agente.html`. Nivel 1 ampliado el 2026-05-17 (tabla comparativa de chats, 5 casos por sector, plantilla de prompt, errores, datos sensibles). Nivel 2 ampliado el 2026-05-18 (comparativa Make/Zapier/n8n/Power Automate con precios, 5 flujos por sector, anatomía de un flujo en 5 bloques, errores frecuentes y control de coste/datos). Nivel 3 ampliado el 2026-05-18 (criterios para subir desde nivel 2, comparativa Claude Agent SDK / LangGraph / OpenAI Assistants / AutoGen, 5 casos — 3 generales + asesoría + e-commerce, errores frecuentes y guard-rails de coste/alcance/registro). Nivel 4 ampliado el 2026-05-19 (cuándo subir desde nivel 3, comparativa Paperclip / Ironclip+BPAC / LangGraph multi-agente / Microsoft Copilot Studio / CrewAI+AutoGen Studio, anatomía de un orquestador en 6 bloques, 5 casos — 3 generales + despacho + sanidad/BPAC, errores frecuentes y gobernanza: presupuesto compartido, identidad por agente, audit log). Currículo profundizado **completo en los 4 niveles**. |
